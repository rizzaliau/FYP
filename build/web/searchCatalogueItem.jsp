...
`                               </br>
                                ...
                                <form method="post" action="searchCatalogueController">

                                    <select name="searchField">
                                        <option value="itemCode" selected>Item Code</option>
                                        <option value="description">Description</option>
                                        <option value="descriptionChinese">Chinese Description</option>
                                        <option value="unitPrice">Unit Price</option>
                                        <option value="defaultQty">Default Quantity</option>
                                        <option value="qtyMultiples">Quantity Multiples</option>
