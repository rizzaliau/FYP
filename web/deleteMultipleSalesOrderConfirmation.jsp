                            ...
                            <div class="card strpied-tabled-with-hover">
                                ...
                                <center>Are you sure you want to delete these items?</center>
                                        ...
                                        <%  
                                            ...
                                            //out.println(deliveryDateRetrieved);
                                            
                                            session.setAttribute("orderIDArrayCancelled", orderIDsRetrived);

                                        %>
                                        
                                        
                                        <form action="deleteMultipleSalesOrderController" method="post">
                                            
                                            <input type= "hidden" name="status" value='<%=statusRetrieved%>'/>
                                            <input type= "hidden" name="deliveryDate" value='<%=deliveryDateRetrieved%>'/>
