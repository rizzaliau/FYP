...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            ...
            <%
                Map<Integer, OrderItem> searchCatalogueMap = (Map<Integer, OrderItem>)request.getAttribute("searchMapResultsCatalogue");
            %>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Search Catalogue list </p>
                                </div>
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <form action="deleteMultipleCatalogueConfirmation.jsp" method="post">
                                            ...
                                            for (Integer number : searchCatalogueMap.keySet()) {
                                                out.print("<tr>");
                                                OrderItem orderItem = searchCatalogueMap.get(number);
                                            ...
                                            %>
                                            <a href="catalogue.jsp"><input class="btn btn-info btn-fill pull-left" type="button" name="Reset search"  value="Reset Search" style="margin:1px;"/></a>
