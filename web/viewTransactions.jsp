<%-- 
    ...
    Created on : 20 Oct, 2018, 11:55:34 PM
    Author     : Rizza
--%>
...
<%@page import="utility.transactionUtility"%>
                            ...
                            <div class="card strpied-tabled-with-hover">
                                ...
                                <div class="card-body table-full-width table-responsive" id='salesOrder'>
                                    <table class="order-table table table-hover table-striped">
                                        ...
                                        <%
                                          String customerCode = request.getParameter("debtorCode");  
                                            
                                          Map<Integer, Transaction> allTransactionsCustomer = transactionUtility.getAllTransactionsCustomer(customerCode);
                                        ...
                                        <thead>   
                                            <% 
                                                if(allTransactionsCustomer.size()!=0){
                                                    out.print("<th>S/N</th>");
                                                }
                                            %>
                                        </thead>
                                        <tbody class="list">
                                            ...
                                            <%
                                                if(allTransactionsCustomer.size()==0){
                                                    out.print("<center>There are no transactions for this wallet!</center>");
                                                }
                                            %>
                                            ...
                                            for (Integer number : allTransactionsCustomer.keySet()) {
                                                out.print("<tr>");
                                                Transaction transaction = allTransactionsCustomer.get(number);

                                                out.print("<td>" + number + "</td>");
                                                
                                                if(transaction.getStatus().equals("New")){
                                                //debit transactions
                                                    out.print("<td><font color='red'><b>-$" +df.format(transaction.getAmount())+
                                                    "</font></b> &nbsp from order #"+transaction.getOrderID()+" on "+adminUtility.formatDate(transaction.getCreatedTimeStamp())+"</td>");                                               
                                                    out.print("</tr>"); 
                                                }else{
                                                //credit transactions
                                                    out.print("<td><font color='green'><b>+$" +df.format(transaction.getAmount())+
                                                    "</font></b> &nbsp from order #"+transaction.getOrderID()+" on "+adminUtility.formatDate(transaction.getCreatedTimeStamp())+"</td>");                                               
                                                    out.print("</tr>");   
                                                }
